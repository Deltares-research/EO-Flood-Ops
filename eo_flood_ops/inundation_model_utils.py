...
class ThresholdingModel:
    ...
    def train(self, minumum_ratios:list, ground_truth: Sequence[GroundTruthMeasurement]):
...
def down_scale(raster: np.ndarray, down_scale_factor: int, fraction: float = 0.1) -> np.ndarray:
    ...
    reshaped = raster_cropped.reshape(H_new // down_scale_factor, down_scale_factor,
                                      W_new // down_scale_factor, down_scale_factor)
